...
//
// *******************************************************************************************************
//   F# Interactive에서 코드를 실행하려면 코드 섹션을 강조 표시하고 Alt-Enter를 누르거나 마우스 오른쪽 단추를 클릭한 다음 
//   "대화형으로 실행"을 선택하십시오.  "보기" 메뉴에서 F# Interactive 창을 열 수 있습니다. 
// *******************************************************************************************************
//
// F#에 대한 자세한 내용은 다음을 참조하십시오:
//     http://fsharp.org
//     https://docs.microsoft.com/ko-kr/dotnet/articles/fsharp/
//
...
//
// F#과 함께 사용할 수 있는 추가 템플릿은 Visual Studio의 다음 위치에서 '온라인 템플릿'을 참조하십시오. 
//     '새 프로젝트' --> '온라인 템플릿'
...
module Immutability =
    ...
    //
    // '='는 이와 같지 않습니다. '='는 같음을 테스트하는 데 사용됩니다.
...
module Lists =
    ...
    /// 리스트는 [ ... ]을 사용하여 정의됩니다. 이것은 빈 리스트입니다.
    let list1 = [ ]  
...
module Arrays =
    ...
    /// 빈 배열입니다. 목록의 구문과 유사하지만 `[| ... |]`를 대신 사용합니다.
    let array1 = [| |]
...
/// 'let rec'을 사용하여 선언할 때.
///
/// 재귀는 F#에서 시퀀스 또는 컬렉션을 처리하는 기본 방법입니다.
///
/// 자세히 알아보려면 다음을 참조하세요. https://docs.microsoft.com/en-us/dotnet/articles/fsharp/language-reference/functions/index#recursive-functions
